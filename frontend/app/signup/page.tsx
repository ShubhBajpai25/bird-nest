...
import { Bird, Mail, Lock, ArrowRight, Eye, EyeOff, User } from "lucide-react";
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="John"
                  className="w-full rounded-lg border border-border bg-bg-deep py-2.5 pl-10 pr-3 text-sm text-text-primary placeholder:text-text-tertiary transition-all duration-200 focus:border-accent-gold/50 focus:outline-none focus:ring-1 focus:ring-accent-gold/30"
                  required
                />
              </div>
            </div>
